...
%package devel
Summary: Development files for carta-cfitsio-v430
Provides: carta-cfitsio-v430-devel

%description devel
Development package of carta-cfitsio-v430 containing the lib and header files.
...
%changelog
* Thu Feb 23 2025 Cheng-Chin Chiang <chcchiang@asiaa.sinica.edu.tw> 4.3.0-1
  - Build cfitsio 4.3.0 from source codes
